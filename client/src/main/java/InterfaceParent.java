				...
				if (!var10.isIf3 || !class263.isComponentHidden(var10)) {
					...
					if (!var10.isIf3 || var15 < var17 && var16 < var18) {
						...
						if (var10.type == 0) {
							...
							InterfaceParent var30 = (InterfaceParent)Client.interfaceParents.get(var10.id);
							if (var30 != null) {
									...
									if (var10.type == 4) {
										...
										if (var10.type == 6) {
											...
											if (var10.itemId != -1) {
												...
												if (var10.modelId == 0) {
													var41 = Client.playerAppearance.getModel(null, -1, null, -1);
												} else {
													var41 = class19.localPlayer.getModel();
												}
											} else if (var20 == -1) {
												var41 = var10.getModel(null, -1, var36, class19.localPlayer.appearance);
