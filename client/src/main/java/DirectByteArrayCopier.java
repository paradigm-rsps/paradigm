				...
				if (var0 != 3214 && var0 != 3215 && var0 != 3210 && var0 != 3182 && var0 != 3204 && var0 != 3206 && var0 != 3208) {
					...
					if (var4 == class82.field1072) {
						...
						case 5:
							...
							break;
						default:
							var7 = String.format("Unkown device option: %s.", var3);
						...
						case 4:
							...
							break;
						default:
							var7 = String.format("Unkown game option: %s.", var4);
							throw new RuntimeException(var7);
						}
					}
			...
			if (var4 >= 0) {
				...
				if (var6 == 22) {
					if (var15.animationId == -1 && var15.transforms == null) {
						...
						var36 = new DynamicObject(var4, 22, var5, var12, var2, var3, var15.animationId, var15.boolean3, null);
					}
					...
					if (var6 >= 12) {
						if (var15.animationId == -1 && var15.transforms == null) {
							...
							var36 = new DynamicObject(var4, var6, var5, var12, var2, var3, var15.animationId, var15.boolean3, null);
						}
						...
						if (var15.animationId == -1 && var15.transforms == null) {
							...
							var36 = new DynamicObject(var4, 0, var5, var12, var2, var3, var15.animationId, var15.boolean3, null);
						}

						var41.newBoundaryObject(var0, var2, var3, var23, (Renderable)var36, null, Tiles.field988[var5], 0, var26, var28);
						if (var15.interactType != 0) {
						...
						if (var15.animationId == -1 && var15.transforms == null) {
							...
							var36 = new DynamicObject(var4, 1, var5, var12, var2, var3, var15.animationId, var15.boolean3, null);
						}

						var41.newBoundaryObject(var0, var2, var3, var23, (Renderable)var36, null, Tiles.field989[var5], 0, var26, var28);
						if (var15.interactType != 0) {
							var14.method3838(var2, var3, var6, var5, var15.boolean1);
						}
					} else {
						...
						if (var6 == 2) {
							...
							if (var15.animationId == -1 && var15.transforms == null) {
								...
								var37 = new DynamicObject(var4, 2, var5 + 4, var12, var2, var3, var15.animationId, var15.boolean3, null);
								var31 = new DynamicObject(var4, 2, var29, var12, var2, var3, var15.animationId, var15.boolean3, null);
							}
							...
							if (var15.animationId == -1 && var15.transforms == null) {
								...
								var36 = new DynamicObject(var4, 3, var5, var12, var2, var3, var15.animationId, var15.boolean3, null);
							}
							...
							if (var15.animationId == -1 && var15.transforms == null) {
								...
								var36 = new DynamicObject(var4, 4, var5, var12, var2, var3, var15.animationId, var15.boolean3, null);
							}

							var41.newWallDecoration(var0, var2, var3, var23, (Renderable)var36, null, Tiles.field988[var5], 0, 0, 0, var26, var28);
						} else {
							long var30;
							Object var32;
							if (var6 == 5) {
								...
								if (var15.animationId == -1 && var15.transforms == null) {
									...
									var32 = new DynamicObject(var4, 4, var5, var12, var2, var3, var15.animationId, var15.boolean3, null);
								}

								var41.newWallDecoration(var0, var2, var3, var23, (Renderable)var32, null, Tiles.field988[var5], 0, var29 * Tiles.field990[var5], var29 * Tiles.field991[var5], var26, var28);
							} else if (var6 == 6) {
								var29 = 8;
								var30 = var41.getBoundaryObjectTag(var0, var2, var3);
								if (0L != var30) {
								...
								if (var15.animationId == -1 && var15.transforms == null) {
									...
									var32 = new DynamicObject(var4, 4, var5 + 4, var12, var2, var3, var15.animationId, var15.boolean3, null);
								}

								var41.newWallDecoration(var0, var2, var3, var23, (Renderable)var32, null, 256, var5, var29 * Tiles.field1000[var5], var29 * Tiles.field993[var5], var26, var28);
							} else if (var6 == 7) {
								int var35 = var5 + 2 & 3;
								if (var15.animationId == -1 && var15.transforms == null) {
									var36 = var15.getModel(4, var35 + 4, var22, var24, var23, var25);
								} else {
									var36 = new DynamicObject(var4, 4, var35 + 4, var12, var2, var3, var15.animationId, var15.boolean3, null);
								}

								var41.newWallDecoration(var0, var2, var3, var23, (Renderable)var36, null, 256, var35, 0, 0, var26, var28);
							} else if (var6 == 8) {
								var29 = 8;
								var30 = var41.getBoundaryObjectTag(var0, var2, var3);
								if (0L != var30) {
								...
								if (var15.animationId == -1 && var15.transforms == null) {
									...
									var32 = new DynamicObject(var4, 4, var5 + 4, var12, var2, var3, var15.animationId, var15.boolean3, null);
									var33 = new DynamicObject(var4, 4, var34 + 4, var12, var2, var3, var15.animationId, var15.boolean3, null);
								}
					...
					if (var15.animationId == -1 && var15.transforms == null) {
						...
						var36 = new DynamicObject(var4, 10, var5, var12, var2, var3, var15.animationId, var15.boolean3, null);
					}
