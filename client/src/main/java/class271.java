			...
			if (var0 == ScriptOpcodes.FRIEND_GETNAME) {
				...
				if (var0 == ScriptOpcodes.FRIEND_SETRANK) {
					...
					if (Statics1.friendsChat != null) {
						Interpreter.Interpreter_stringStack[++ChatChannel.Interpreter_stringStackSize - 1] = Statics1.friendsChat.name;
					} else {
						Interpreter.Interpreter_stringStack[++ChatChannel.Interpreter_stringStackSize - 1] = "";
					}
					...
					if (Statics1.friendsChat != null) {
						Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = Statics1.friendsChat.getSize();
					} else {
						Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = 0;
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize];
					if (Statics1.friendsChat != null && var3 < Statics1.friendsChat.getSize()) {
						Interpreter.Interpreter_stringStack[++ChatChannel.Interpreter_stringStackSize - 1] = Statics1.friendsChat.get(var3).getUsername().getName();
					} else {
						Interpreter.Interpreter_stringStack[++ChatChannel.Interpreter_stringStackSize - 1] = "";
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize];
					if (Statics1.friendsChat != null && var3 < Statics1.friendsChat.getSize()) {
						Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = ((Buddy) Statics1.friendsChat.get(var3)).getWorld();
					} else {
						Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = 0;
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize];
					if (Statics1.friendsChat != null && var3 < Statics1.friendsChat.getSize()) {
						Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = ((Buddy) Statics1.friendsChat.get(var3)).rank;
					} else {
						Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = 0;
					}
					...
					Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = Statics1.friendsChat != null ? Statics1.friendsChat.minKick : 0;
					return 1;
					...
					Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = Statics1.friendsChat != null ? Statics1.friendsChat.rank * 1904728549 * -272778259 : 0;
					return 1;
					...
					var3 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize];
					if (Statics1.friendsChat != null && var3 < Statics1.friendsChat.getSize() && Statics1.friendsChat.get(var3).getUsername().equals(class19.localPlayer.username)) {
						Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (Statics1.friendsChat != null && Statics1.friendsChat.owner != null) {
						Interpreter.Interpreter_stringStack[++ChatChannel.Interpreter_stringStackSize - 1] = Statics1.friendsChat.owner;
					} else {
						Interpreter.Interpreter_stringStack[++ChatChannel.Interpreter_stringStackSize - 1] = "";
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize];
					if (Statics1.friendsChat != null && var3 < Statics1.friendsChat.getSize() && ((ClanMate) Statics1.friendsChat.get(var3)).isFriend()) {
						Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (var0 == 3628) {
						...
						if (var0 == 3629) {
							...
							if (Statics1.friendsChat != null) {
								Statics1.friendsChat.removeComparator();
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize] == 1;
							if (Statics1.friendsChat != null) {
								Statics1.friendsChat.addComparator(new UserComparator1(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize] == 1;
							if (Statics1.friendsChat != null) {
								Statics1.friendsChat.addComparator(new UserComparator2(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize] == 1;
							if (Statics1.friendsChat != null) {
								Statics1.friendsChat.addComparator(new UserComparator3(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize] == 1;
							if (Statics1.friendsChat != null) {
								Statics1.friendsChat.addComparator(new UserComparator4(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize] == 1;
							if (Statics1.friendsChat != null) {
								Statics1.friendsChat.addComparator(new UserComparator5(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize] == 1;
							if (Statics1.friendsChat != null) {
								Statics1.friendsChat.addComparator(new UserComparator6(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize] == 1;
							if (Statics1.friendsChat != null) {
								Statics1.friendsChat.addComparator(new UserComparator7(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize] == 1;
							if (Statics1.friendsChat != null) {
								Statics1.friendsChat.addComparator(new UserComparator8(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize] == 1;
							if (Statics1.friendsChat != null) {
								Statics1.friendsChat.addComparator(new UserComparator9(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize] == 1;
							if (Statics1.friendsChat != null) {
								Statics1.friendsChat.addComparator(new UserComparator10(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize] == 1;
							if (Statics1.friendsChat != null) {
								Statics1.friendsChat.addComparator(new BuddyRankComparator(var7));
							}
					...
					var3 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize];
					if (Statics1.friendsChat != null && var3 < Statics1.friendsChat.getSize() && ((ClanMate) Statics1.friendsChat.get(var3)).isIgnored()) {
						Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = 0;
					}
