		...
		if (var0 != null && var0.method2706() != 0) {
			if (var1 < (float)var0.field1430[0].field1384) {
				...
				if (var2 == null) {
					...
					if (0.0D == (double)var2.field1388 && 0.0D == (double)var2.field1389) {
						var3 = true;
							...
							if (var0.field1434) {
								if (var0 != null) {
									...
									if (0.0D != (double)var7) {
										...
										if ((double)var16 > 1.0D) {
											var16 = 1.0F;
										}

										if ((double)var15 > 1.0D || var16 < -1.0F) {
										...
										if (var16 != var13) {
											...
											if (1.0D != (double)var13) {
												var6[2] = (float)((double)var6[3] - (double)(var6[3] - var6[2]) * (1.0D - (double)var16) / (1.0D - (double)var13));
											}
										}
