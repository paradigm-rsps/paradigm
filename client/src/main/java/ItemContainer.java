public class ItemContainer extends Node {
	...
	public static SequenceDefinition SequenceDefinition_get(int var0) {
		SequenceDefinition var1 = (SequenceDefinition)SequenceDefinition.SequenceDefinition_cached.get(var0);
		if (var1 != null) {
			return var1;
		} else {
			...
			var1.postDecode();
			SequenceDefinition.SequenceDefinition_cached.put(var1, var0);
			return var1;
		}
	}
