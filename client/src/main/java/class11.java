...
class class11 implements TlsAuthentication {
	...
	public void notifyServerCertificate(Certificate var1) throws IOException {
		try {
			...
			this.this$2.this$1.field65 = (java.security.cert.Certificate[]) var3.toArray(new java.security.cert.Certificate[0]);
	...
	static final void drawObject(int var0, int var1, int var2, int var3, int var4) {
		long var5 = FriendSystem.scene.getBoundaryObjectTag(var0, var1, var2);
		int var7;
		int var8;
		int var9;
		int var10;
		...
		var5 = FriendSystem.scene.getFloorDecorationTag(var0, var1, var2);
		if (0L != var5) {
