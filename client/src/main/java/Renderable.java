		...
		for (var2 = 0; var2 < 4; ++var2) {
			...
			for (var11 = 1; var11 < 103; ++var11) {
				for (var12 = 1; var12 < 103; ++var12) {
					...
					var15 = (int)Math.sqrt(var14 * var14 + var13 * var13 + 65536);
					var16 = (var13 << 8) / var15;
					var17 = 65536 / var15;
					var18 = (var14 << 8) / var15;
					...
					for (var17 = -5; var17 < 109; ++var17) {
						...
						if (var17 >= 1 && var17 < 103 && (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var11][var17] & 2) != 0 || (Tiles.Tiles_renderFlags[var2][var11][var17] & 16) == 0)) {
							...
							if (var20 > 0 || var21 > 0) {
								...
								if (var2 > 0) {
									boolean var57 = var20 != 0 || Tiles.Tiles_shapes[var2][var11][var17] == 0;

									if (var21 > 0) {
										var34 = var21 - 1;
										var35 = (FloorOverlayDefinition)FloorOverlayDefinition.FloorOverlayDefinition_cached.get(var34);
										...
										if (var35 != null) {
											...
											var35.postDecode();
											FloorOverlayDefinition.FloorOverlayDefinition_cached.put(var35, var34);
											var46 = var35;
										}
								...
								if (var21 == 0) {
									...
									int var47 = var21 - 1;
									FloorOverlayDefinition var37 = (FloorOverlayDefinition)FloorOverlayDefinition.FloorOverlayDefinition_cached.get(var47);
									if (var37 != null) {
										var35 = var37;
									} else {
										...
										var37.postDecode();
										FloorOverlayDefinition.FloorOverlayDefinition_cached.put(var37, var47);
										var35 = var37;
									}
