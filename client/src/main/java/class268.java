...
public final class class268 {
	...
	public static EnumComposition getEnum(int var0) {
		EnumComposition var1 = (EnumComposition)EnumComposition.EnumDefinition_cached.get(var0);
		if (var1 != null) {
			return var1;
		} else {
			...
			EnumComposition.EnumDefinition_cached.put(var1, var0);
			return var1;
		}
	}
	...
	public static boolean method5227(int var0) {
		return var0 >= 0 && var0 < 112 && KeyHandler.field121[var0];
	}
