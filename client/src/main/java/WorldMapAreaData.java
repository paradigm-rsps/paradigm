				...
				if (var1.creationErrors[var3] != 0) {
					...
					try {
						...
						if (var4 == 0) {
							...
							var6 = Reflection.getInt(var5, null);
							var0.writeByte(0);
							var0.writeInt(var6);
						} else if (var4 == 1) {
							var5 = var1.fields[var3];
							Reflection.setInt(var5, null, var1.intReplaceValues[var3]);
							var0.writeByte(0);
						} else if (var4 == 2) {
							var5 = var1.fields[var3];
						...
						if (var4 != 3) {
							...
							Object var11 = Reflection.invoke(var25, null, var7);
							if (var11 == null) {
								var0.writeByte(0);
			...
			try {
				...
				while (true) {
					...
					if (var6 == 4) {
						var9 = var2[var4++] << 16;
						var9 += var2[var4++];
						var10 = HorizontalAlignment.getWidget(var9);
						var11 = var2[var4++];
						if (var11 != -1 && (!class67.ItemDefinition_get(var11).isMembersOnly || Client.isMembersWorld)) {
					...
					if (var6 == 14) {
						var9 = var2[var4++];
						var7 = WorldMapRegion.getVarbit(var9);
					}
