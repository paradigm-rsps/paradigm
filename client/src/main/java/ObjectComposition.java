public class ObjectComposition extends DualNode {
	...
	public final Renderable getEntity(int var1, int var2, int[][] var3, int var4, int var5, int var6) {
		...
		Object var9 = ObjectDefinition_cachedEntities.get(var7);
		if (var9 == null) {
	...
	final ModelData getModelData(int var1, int var2) {
		...
		if (this.models == null) {
			...
			for (int var6 = 0; var6 < var5; ++var6) {
				...
				var3 = (ModelData)ObjectDefinition_cachedModelData.get(var7);
				if (var3 == null) {
			...
			var3 = (ModelData)ObjectDefinition_cachedModelData.get(var5);
			if (var3 == null) {
				...
				ObjectDefinition_cachedModelData.put(var3, var5);
			}
		}
	...
	static final void FriendSystem_invalidateIgnoreds() {
		...
		if (Statics1.friendsChat != null) {
			Statics1.friendsChat.invalidateIgnoreds();
		}
