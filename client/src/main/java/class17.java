	...
	static int method259(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.MES) {
			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				...
				PacketBufferNode var13 = ItemContainer.getPacketBufferNode(ClientPacket.field2939, Client.packetWriter.isaacCipher);
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					var7 = Interpreter.Interpreter_stringStack[--ChatChannel.Interpreter_stringStackSize];
					var11 = ItemContainer.getPacketBufferNode(ClientPacket.field2910, Client.packetWriter.isaacCipher);
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						var10 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize];
						var11 = ItemContainer.getPacketBufferNode(ClientPacket.field2962, Client.packetWriter.isaacCipher);
		...
		if (var0 == ScriptOpcodes.ADD) {
			...
			if (var0 == ScriptOpcodes.INTERPOLATE) {
				...
				if (var3 == 0) {
					...
					Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = (int)Math.pow(var3, var4);
				}
				...
				if (var3 == 0) {
					...
					case 1:
						...
						break;
					case 2:
						Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = (int)Math.sqrt(var3);
						break;
					case 3:
						Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = (int)Math.cbrt(var3);
						break;
					case 4:
						Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = (int)Math.sqrt(Math.sqrt(var3));
						break;
					default:
						Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = (int)Math.pow(var3, 1.0D / (double)var4);
					}
				...
				class295.Interpreter_intStackSize -= 3;
				long var9 = Interpreter.Interpreter_intStack[class295.Interpreter_intStackSize];
				long var11 = Interpreter.Interpreter_intStack[class295.Interpreter_intStackSize + 1];
				long var13 = Interpreter.Interpreter_intStack[class295.Interpreter_intStackSize + 2];
