			...
			if (var5 == 22) {
				if (!Client.isLowDetail || var8.int1 != 0 || var8.interactType == 1 || var8.boolean2) {
					if (var8.animationId == -1 && var8.transforms == null) {
						...
						var34 = new DynamicObject(var3, 22, var4, var0, var1, var2, var8.animationId, var8.boolean3, null);
					}
				...
				if (var5 >= 12) {
					if (var8.animationId == -1 && var8.transforms == null) {
						...
						var34 = new DynamicObject(var3, var5, var4, var0, var1, var2, var8.animationId, var8.boolean3, null);
					}
					...
					if (var8.animationId == -1 && var8.transforms == null) {
						...
						var34 = new DynamicObject(var3, 0, var4, var0, var1, var2, var8.animationId, var8.boolean3, null);
					}

					var6.newBoundaryObject(var0, var1, var2, var16, (Renderable)var34, null, Tiles.field988[var4], 0, var19, var21);
					if (var4 == 0) {
						if (var8.clipped) {
					...
					if (var8.animationId == -1 && var8.transforms == null) {
						...
						var34 = new DynamicObject(var3, 1, var4, var0, var1, var2, var8.animationId, var8.boolean3, null);
					}

					var6.newBoundaryObject(var0, var1, var2, var16, (Renderable)var34, null, Tiles.field989[var4], 0, var19, var21);
					if (var8.clipped) {
						if (var4 == 0) {
							GrandExchangeOfferNameComparator.field4010[var0][var1][var2 + 1] = 50;
						} else if (var4 == 1) {
					...
					if (var5 == 2) {
						...
						if (var8.animationId == -1 && var8.transforms == null) {
							...
							var31 = new DynamicObject(var3, 2, var4 + 4, var0, var1, var2, var8.animationId, var8.boolean3, null);
							var32 = new DynamicObject(var3, 2, var28, var0, var1, var2, var8.animationId, var8.boolean3, null);
						}
						...
						if (var8.animationId == -1 && var8.transforms == null) {
							...
							var34 = new DynamicObject(var3, 3, var4, var0, var1, var2, var8.animationId, var8.boolean3, null);
						}
						...
						if (var8.animationId == -1 && var8.transforms == null) {
							...
							var34 = new DynamicObject(var3, 4, var4, var0, var1, var2, var8.animationId, var8.boolean3, null);
						}

						var6.newWallDecoration(var0, var1, var2, var16, (Renderable)var34, null, Tiles.field988[var4], 0, 0, 0, var19, var21);
					} else {
						Object var25;
						long var29;
						if (var5 == 5) {
							...
							if (var8.animationId == -1 && var8.transforms == null) {
								...
								var25 = new DynamicObject(var3, 4, var4, var0, var1, var2, var8.animationId, var8.boolean3, null);
							}

							var6.newWallDecoration(var0, var1, var2, var16, (Renderable)var25, null, Tiles.field988[var4], 0, var28 * Tiles.field990[var4], var28 * Tiles.field991[var4], var19, var21);
						} else if (var5 == 6) {
							var28 = 8;
							var29 = var6.getBoundaryObjectTag(var0, var1, var2);
							if (0L != var29) {
							...
							if (var8.animationId == -1 && var8.transforms == null) {
								...
								var25 = new DynamicObject(var3, 4, var4 + 4, var0, var1, var2, var8.animationId, var8.boolean3, null);
							}

							var6.newWallDecoration(var0, var1, var2, var16, (Renderable)var25, null, 256, var4, var28 * Tiles.field1000[var4], var28 * Tiles.field993[var4], var19, var21);
						} else if (var5 == 7) {
							var23 = var4 + 2 & 3;
							if (var8.animationId == -1 && var8.transforms == null) {
								var34 = var8.getEntity(4, var23 + 4, var15, var17, var16, var18);
							} else {
								var34 = new DynamicObject(var3, 4, var23 + 4, var0, var1, var2, var8.animationId, var8.boolean3, null);
							}

							var6.newWallDecoration(var0, var1, var2, var16, (Renderable)var34, null, 256, var23, 0, 0, var19, var21);
						} else if (var5 == 8) {
							var28 = 8;
							var29 = var6.getBoundaryObjectTag(var0, var1, var2);
							if (0L != var29) {
							...
							if (var8.animationId == -1 && var8.transforms == null) {
								...
								var25 = new DynamicObject(var3, 4, var4 + 4, var0, var1, var2, var8.animationId, var8.boolean3, null);
								var26 = new DynamicObject(var3, 4, var27 + 4, var0, var1, var2, var8.animationId, var8.boolean3, null);
							}
				...
				if (var8.animationId == -1 && var8.transforms == null) {
					...
					var34 = new DynamicObject(var3, 10, var4, var0, var1, var2, var8.animationId, var8.boolean3, null);
				}
