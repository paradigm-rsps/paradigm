					...
					try {
						...
						try {
							...
							while (true) {
								...
								if (var33 >= 100) {
									boolean var35;
									var35 = var4.intOperands[var20] == 1;
									...
									if (var33 != ScriptOpcodes.INVOKE) {
										if (var33 == ScriptOpcodes.GET_VARC_INT) {
											...
											if (var33 == ScriptOpcodes.GET_VARC_STRING_OLD) {
												...
												IntegerNode var37 = (IntegerNode)var38.get(Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize]);
												if (var37 != null) {
													var20 += var37.integer;
												}
											} else {
							...
							var27.append(var4.key).append(" ");

							for (var13 = Interpreter.Interpreter_frameDepth - 1; var13 >= 0; --var13) {
								var27.append(Interpreter.Interpreter_frames[var13].script.key).append(" ");
							}
						...
						if (var30) {
							...
							if (!var9 && var2 > 0 && var10 >= var2) {
								class301.RunException_sendStackTrace("Warning: Script " + var4.field959 + " finished at op count " + var10 + " of max " + var1, null);
							}
