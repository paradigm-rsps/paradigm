...
public final class class387 {
	...
	float[] method7086() {
		...
		if ((double)this.field4347[2] < 0.999D && (double)this.field4347[2] > -0.999D) {
			var1[1] = (float)(-Math.asin(this.field4347[2]));
			...
			var1[0] = 0.0F;
			var1[1] = (float)Math.atan2(this.field4347[2], 0.0D);
			var1[2] = (float)Math.atan2(-this.field4347[9], this.field4347[5]);
		}
	...
	public float[] method7072() {
		float[] var1 = new float[]{(float)(-Math.asin(this.field4347[6])), 0.0F, 0.0F};
		double var2 = Math.cos(var1[0]);
		double var4;
		double var6;
		if (Math.abs(var2) > 0.005D) {
			var4 = this.field4347[2];
			var6 = this.field4347[10];
			double var8 = this.field4347[4];
			double var10 = this.field4347[5];
			var1[1] = (float)Math.atan2(var4, var6);
			var1[2] = (float)Math.atan2(var8, var10);
		} else {
			var4 = this.field4347[1];
			var6 = this.field4347[0];
