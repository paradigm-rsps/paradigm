public class class9 implements MouseWheel {
	...
	public static NPCComposition getNpcDefinition(int var0) {
		NPCComposition var1 = (NPCComposition)NPCComposition.NpcDefinition_cached.get(var0);
		if (var1 != null) {
			return var1;
		} else {
			...
			var1.postDecode();
			NPCComposition.NpcDefinition_cached.put(var1, var0);
			return var1;
		}
	}
	...
	static final void method85() {
		PacketBufferNode var0 = ItemContainer.getPacketBufferNode(ClientPacket.field2905, Client.packetWriter.isaacCipher);
