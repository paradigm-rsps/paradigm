public class LoginScreenAnimation {
	...
	final void method2222(int var1) {
		...
		for (var7 = 256 - var1; var7 < 256; ++var7) {
			this.field1222[var7] = (int)(Math.sin((double)this.field1218 / 14.0D) * 16.0D + Math.sin((double)this.field1218 / 15.0D) * 14.0D + Math.sin((double)this.field1218 / 16.0D) * 12.0D);
			++this.field1218;
		}
	...
	final void method2227(IndexedSprite var1) {
		...
		for (var2 = 0; var2 < 5000; ++var2) {
			...
			this.field1206[var3] = (int)(Math.random() * 256.0D);
		}
