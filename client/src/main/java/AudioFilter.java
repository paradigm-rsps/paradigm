public class AudioFilter {
	...
	int compute(int var1, float var2) {
		...
		if (var1 == 0) {
			...
			var3 *= 0.0030517578F;
			field412 = (float)Math.pow(0.1D, var3 / 20.0F);
		...
		if (this.pairs[var1] == 0) {
			...
			field415[var1][0] = -2.0F * var3 * (float)Math.cos(this.method1055(var1, 0, var2));
			...
			for (var4 = 1; var4 < this.pairs[var1]; ++var4) {
				...
				float var5 = -2.0F * var3 * (float)Math.cos(this.method1055(var1, var4, var2));
