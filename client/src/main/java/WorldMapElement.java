public class WorldMapElement extends DualNode {
	...
	SpritePixels getSprite(int var1) {
		if (var1 < 0) {
			...
			SpritePixels var2 = (SpritePixels)WorldMapElement_cachedSprites.get(var1);
			if (var2 != null) {
				return var2;
			} else {
				var2 = InterfaceParent.SpriteBuffer_getSprite(WorldMapElement_archive, var1, 0);
				if (var2 != null) {
					WorldMapElement_cachedSprites.put(var2, var1);
				}
	...
	public static void method3384(int var0, int var1) {
		VarbitComposition var3 = (VarbitComposition)VarbitComposition.VarbitDefinition_cached.get(var0);
