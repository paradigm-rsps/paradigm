...
public class Varcs {
	...
	Varcs() {
		...
		for (var2 = 0; var2 < var1; ++var2) {
			VarcInt var4 = (VarcInt)VarcInt.VarcInt_cached.get(var2);
			VarcInt var3;
			if (var4 != null) {
				var3 = var4;
			} else {
				...
				VarcInt.VarcInt_cached.put(var4, var2);
				var3 = var4;
			}
			...
			if (var9 != null && var9.parentId == var1 && (var9.method5637() || WorldMapSection2.getWidgetFlags(var9) != 0 || var9 == Client.clickedWidgetParent)) {
				...
				if (var34 || !var9.isIf3 || var12 < var14 && var13 < var15) {
					...
					if (var9.contentType == 1337) {
						...
						if (var9.isIf3) {
							var35 = MouseHandler.MouseHandler_x >= var12 && MouseHandler.MouseHandler_y >= var13 && MouseHandler.MouseHandler_x < var14 && MouseHandler.MouseHandler_y < var15;

							boolean var36 = (MouseHandler.MouseHandler_currentButton == 1 || !UserComparator5.mouseCam && MouseHandler.MouseHandler_currentButton == 4) && var35;
							var21 = (MouseHandler.MouseHandler_lastButton == 1 || !UserComparator5.mouseCam && MouseHandler.MouseHandler_lastButton == 4) && MouseHandler.MouseHandler_lastPressedX >= var12 && MouseHandler.MouseHandler_lastPressedY >= var13 && MouseHandler.MouseHandler_lastPressedX < var14 && MouseHandler.MouseHandler_lastPressedY < var15;
						...
						if (var9.type == 0) {
							...
							InterfaceParent var30 = (InterfaceParent)Client.interfaceParents.get(var9.id);
							if (var30 != null) {
