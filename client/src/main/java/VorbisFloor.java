public class VorbisFloor {
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			this.field269 = new int[var5];
			this.field269[0] = 0;
			this.field269[1] = 1 << var4;
			var5 = 2;
			...
			for (var6 = 0; var6 < var2; ++var6) {
				...
				for (int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
					this.field269[var5++] = VorbisSample.readBits(var4);
				}
			}

			if (field274 == null || field274.length < var5) {
				field274 = new int[var5];
				field268 = new int[var5];
				field278 = new boolean[var5];
			}
	...
	void method697(int var1, int var2, int var3, int var4, float[] var5, int var6) {
		int var7 = var4 - var2;
		int var8 = var3 - var1;
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			int var2 = this.field269.length;

			int var3;
			for (var3 = 0; var3 < var2; ++var3) {
				field274[var3] = this.field269[var3];
			}

			var3 = field276[this.multiplier - 1];
			int var4 = class326.iLog(var3 - 1);
			field268[0] = VorbisSample.readBits(var4);
			field268[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				int var11 = 0;
				if (var9 > 0) {
					var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method999();
				}

				for (int var12 = 0; var12 < var8; ++var12) {
					int var13 = this.subclassBooks[var7][var11 & var10];
					var11 >>>= var9;
					field268[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method999() : 0;
				}
			}
	...
	void method700(float[] var1, int var2) {
		int var3 = this.field269.length;
		int var4 = field276[this.multiplier - 1];
		boolean[] var5 = field278;
		field278[1] = true;
		var5[0] = true;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method709(field274, var6);
			var8 = method705(field274, var6);
			var9 = this.method696(field274[var7], field268[var7], field274[var8], field268[var8], field274[var6]);
			var10 = field268[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field278;
				field278[var8] = true;
				var14[var7] = true;
				field278[var6] = true;
				if (var10 >= var13) {
					field268[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field268[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field278[var6] = false;
				field268[var6] = var9;
		...
		var6 = 0;
		var7 = field268[0] * this.multiplier;

		for (var8 = 1; var8 < var3; ++var8) {
			if (field278[var8]) {
				var9 = field274[var8];
				var10 = field268[var8] * this.multiplier;
				this.method697(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
