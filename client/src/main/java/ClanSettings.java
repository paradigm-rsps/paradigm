public class ClanSettings {
	...
	public Integer getTitleGroupValue(int var1) {
		if (this.parameters == null) {
			...
			Node var2 = this.parameters.get(var1);
	...
	boolean method2927(int var1, int var2) {
		if (this.parameters != null) {
			Node var3 = this.parameters.get(var1);
			if (var3 != null) {
		...
		this.parameters.put(new IntegerNode(var2), var1);
		return true;
	}
	...
	boolean method2928(int var1, int var2, int var3, int var4) {
		...
		var2 &= var7;
		if (this.parameters != null) {
			Node var8 = this.parameters.get(var1);
			if (var8 != null) {
	...
	boolean method2938(int var1, long var2) {
		if (this.parameters != null) {
			Node var4 = this.parameters.get(var1);
			if (var4 != null) {
		...
		this.parameters.put(new class406(var2), var1);
		return true;
	}
	...
	boolean method2956(int var1, String var2) {
		...
		this.parameters.put(new ObjectNode(var2), var1);
		return true;
	}
				...
				if (var4 > 0) {
					...
					while (var4-- > 0) {
						...
						if (var7 == 0) {
							...
							this.parameters.put(new IntegerNode(var12), var6);
						} else if (var7 == 1) {
							long var10 = var1.readLong();
							this.parameters.put(new class406(var10), var6);
						} else if (var7 == 2) {
							String var8 = var1.readStringCp1252NullTerminated();
							this.parameters.put(new ObjectNode(var8), var6);
						}
					}
				}
			}
		...
		for (int var2 = 0; var2 < var0.length; ++var2) {
			...
			if (var3 != null) {
				if (var3.type == 0) {
					...
					InterfaceParent var4 = (InterfaceParent)Client.interfaceParents.get(var3.id);
					if (var4 != null) {
