public class ItemComposition extends DualNode {
	...
	public final Model getModel(int var1) {
		...
		Model var5 = (Model)ItemDefinition_cachedModels.get(this.id);
		if (var5 != null) {
			return var5;
		} else {
			...
			if (var6 == null) {
				...
				ItemDefinition_cachedModels.put(var5, this.id);
				return var5;
			}
		}
	}
	...
	public final boolean hasNoValidModel(boolean var1) {
		...
		if (var2 == -1) {
			...
			boolean var5 = GameEngine.ItemDefinition_modelArchive.tryLoadFile(var2, 0);
	...
	public final boolean method3748(boolean var1) {
		...
		if (var2 == -1) {
			...
			boolean var4 = GameEngine.ItemDefinition_modelArchive.tryLoadFile(var2, 0);
	...
	static void method3751() {
        int var0 = Players.gpiLocalPlayerCount;
        int[] var1 = Players.gpiLocalPlayerIndexes;

        for (int var2 = 0; var2 < var0; ++var2) {
            if (var1[var2] != Client.combatTargetPlayerIndex && var1[var2] != Client.localPlayerIndex) {
                class166.addPlayerToScene(Client.gpiLocalPlayers[var1[var2]], true);
            }
        }
