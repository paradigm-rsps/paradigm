...
class ObjectConfig(override val id: Int) : Config(id) {
    ...
    var anInt2112: Int = 0
    var anInt2113: Int = 0
    var ambientSoundRadius: Short = 0
    ...
    companion object : ConfigCompanion<ObjectConfig>() {
        ...
        override fun decode(id: Int, data: ByteBuf): ObjectConfig {
            ...
            decoder@ while (true) {
                when (val opcode = data.readUnsignedByte().toInt()) {
                    ...
                    17 -> {
                        ...
                        objectConfig.blockPath = false
                    }
                    18 -> objectConfig.blockProjectile = false
                    19 -> objectConfig.interactType = data.readUnsignedByte()
                    ...
                    24 -> {
                        ...
                        if (objectConfig.animationId == 65535) {
                            objectConfig.animationId = -1
                        }
                    }
                    ...
                    77, 92 -> {
                        ...
                        objectConfig.varbit = if (transformVarbit == 65535) null else transformVarbit
                        val transformVarp = data.readUnsignedShort()
                        objectConfig.varp = if (transformVarbit == 65535) null else transformVarp
                    ...
                    78 -> {
                        ...
                        objectConfig.ambientSoundRadius = data.readUnsignedByte()
                    }
                    79 -> {
            ...
            if (objectConfig.interactType == null) {
